...
|
*/
$config['auth_library_class'] = 'deflib';
$config['auth_library_function'] = 'islogin';
/*
|--------------------------------------------------------------------------
...
/payment
/reversal
Edited: REST_controller _auth_override_check 'strtolower' => route class and method
*/

$config['auth_override_class_method']['def']['*'] = 'none';
$config['auth_override_class_method']['out']['*'] = 'none';
$config['auth_override_class_method']['pab']['*'] = 'none';
// $config['auth_override_class_method']['report']['*'] = 'none';
...
*/
$config['auth_override_class_method_http']['auth']['basic']['post'] = 'none';
$config['auth_override_class_method_http']['master']['*']['post'] = 'none';
$config['auth_override_class_method_http']['master']['*']['get'] = 'none';
$config['auth_override_class_method_http']['master']['register']['put'] = 'none';
$config['auth_override_class_method_http']['document']['*']['post'] = 'none';
$config['auth_override_class_method_http']['document']['*']['get'] = 'none';
$config['auth_override_class_method_http']['report']['*']['post'] = 'none';
$config['auth_override_class_method_http']['report']['*']['get'] = 'none';
$config['auth_override_class_method_http']['empu']['register']['get'] = 'none';
$config['auth_override_class_method_http']['empu']['register']['post'] = 'none';
$config['auth_override_class_method_http']['empu']['confirm']['post'] = 'none';
$config['auth_override_class_method_http']['setting']['rate']['post'] = 'none';
$config['auth_override_class_method_http']['tracking']['*']['post'] = 'none';
$config['auth_override_class_method_http']['tracking']['*']['get'] = 'none';
...
|
*/
$config['rest_keys_table'] = 'sys_keys';
...
|
*/
$config['rest_logs_table'] = 'sys_logs';
...
|
*/
$config['allowed_cors_origins'] = ['https://reborn.aplog.co.id'];
